...
class Pagination(object):
    def __init__(self, current_page, all_count, base_url,params, per_page_num=8, pager_count=11, ):
        ...
        :param params: 接收request.GET对象,目的是为了获取url 如xxx.xx?page=1&&id=2&xx='xxx'
    ...
    def page_html(self):
        ...
        # 加bootstrap分页div和ul标签
        page_html_list.append('<div id="pagination" class="pull-right">')
        page_html_list.append('<ul class="pagination">')
